...
class Test():
    ...
    def test_sougou(self):  # 用例标题
        ...
        result_element = self.driver.find_element(By.CSS_SELECTOR, "#sogou_vr_30000000_0 > em")
        # 获取到定位的文本信息:result_element.text
        # 判断实际获取到的搜索展示的列表和预期的是否一致
        # 实际结果、预期结果
        assert result_element.text == "霍格沃兹测试开发"
